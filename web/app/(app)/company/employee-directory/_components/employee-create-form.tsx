...
import { EmploymentTypeField } from "@/app/(app)/company/employee-directory/_components/employment-type-field"
import { useRouter } from "next/navigation"
import { useActionState } from "react"
import { toast } from "sonner"
import { createEmployeeAction } from "@/app/(app)/company/employee-directory/actions"
import type { EmployeeCreateFormState } from "@/app/(app)/company/employee-directory/actions"
...
export function EmployeeCreateForm(props: {
  ...
  async function reduce(
    ...
    if (result.ok) {
      ...
      router.push("/company/employee-directory")
