import { formatLifecycleDate } from "@/app/(app)/company/employee-directory/[employee]/_lib/format-lifecycle-date"
import { TextLink } from "@/components/text-link"
import { formatLifecycleDisplayStatus } from "@/app/(app)/company/employee-directory/[employee]/_lib/format-lifecycle-display-status"
    ...
    <Card>
      ...
      <CardContent>
        ...
        {props.events.next_cursor !== null ? (
          <div className="mt-4">
            <TextLink
              href={`/company/employee-directory/${encodeURIComponent(props.code)}/timeline?cursor=${encodeURIComponent(props.events.next_cursor)}`}
              prefetch={false}
