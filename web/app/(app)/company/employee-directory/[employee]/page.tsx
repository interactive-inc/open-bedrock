...
import { EmployeeDetail } from "@/app/(app)/company/employee-directory/[employee]/_components/employee-detail"
import { EmployeeEventHistory } from "@/app/(app)/company/employee-directory/[employee]/_components/employee-event-history"
import { EmployeeGradeHistory } from "@/app/(app)/company/employee-directory/[employee]/_components/employee-grade-history"
import { EmployeeSalaryRevisionHistory } from "@/app/(app)/company/employee-directory/[employee]/_components/employee-salary-revision-history"
import { EmployeeWorkStyleHistory } from "@/app/(app)/company/employee-directory/[employee]/_components/employee-work-style-history"
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title="従業員詳細">
        <BackButton href="/company/employee-directory" label="一覧に戻る" />
      </PageHeader>
