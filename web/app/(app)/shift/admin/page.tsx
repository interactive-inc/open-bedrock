...
import { ShiftSwapAdminFilterForm } from "@/app/(app)/shift/admin/_components/shift-swap-admin-filter-form"
import { ShiftSwapAdminTable } from "@/app/(app)/shift/admin/_components/shift-swap-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "シフト", href: "/shift" }, { label: "交代管理" }]}
        actions={
          <Button variant="outline" nativeButton={false} render={<Link href="/shift" />}>
            自分のシフトへ
          </Button>
        }
      />
