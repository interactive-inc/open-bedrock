...
} from "@/app/(app)/applications/workflow-repairs/actions"
...
function WorkflowRepairCard(props: { repair: WorkflowRepair }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          <Link href={`/applications/${repair.id}`} className="underline-offset-4 hover:underline">
        ...
        <CardAction>
          <Badge variant="secondary">{reasonLabels[repair.reason]}</Badge>
        </CardAction>
      </CardHeader>
