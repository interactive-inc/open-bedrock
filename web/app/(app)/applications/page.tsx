...
import { AdminApplicationsFilterForm } from "@/app/(app)/applications/_components/admin-applications-filter-form"
import { AdminApplicationsTable } from "@/app/(app)/applications/_components/admin-applications-table"
...
export const metadata = { title: "申請一覧" }
      ...
      <PageHeader title="申請一覧">
        {canRepairWorkflows ? (
          <Button
            variant="secondary"
            nativeButton={false}
            render={<Link href="/workflow-repairs" />}
          >
            ワークフロー修復
          </Button>
        ) : null}
