...
import { RentalAdminFilterForm } from "@/app/(app)/rentals/admin/_components/rental-admin-filter-form"
import { RentalAdminTable } from "@/app/(app)/rentals/admin/_components/rental-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "貸与品予約", href: "/rentals" }, { label: "貸与品予約管理" }]}
        actions={
