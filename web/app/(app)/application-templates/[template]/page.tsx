...
import { SubmitApplicationForm } from "@/app/(app)/application-templates/[template]/_components/submit-application-form"
import { TemplateManagement } from "@/app/(app)/application-templates/_components/template-management"
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title={template.name}>
        <BackButton href="/application-templates" label="テンプレ一覧へ" />
      </PageHeader>
