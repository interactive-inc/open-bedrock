...
import { submitApplicationAction } from "@/app/(app)/application-templates/[template]/actions"
import type { SubmitState } from "@/app/(app)/application-templates/[template]/actions"
