...
import { toPercentLabel } from "@/app/(app)/dashboard/management/_lib/to-percent-label"
import type { GoalDoneRate } from "@/app/(app)/dashboard/management/_lib/management-dashboard-types"
