...
import { DocumentWorkflowActions } from "@/app/(app)/governance/[code]/_components/document-workflow-actions"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "規程・手続き", href: "/governance" }, { label: document.title }]}
        actions={<BackButton href="/governance" label="一覧に戻る" />}
      />
...
function ReferenceBadge(props: { kind: string; code: string }) {
  if (
    ...
    return (
      <Badge variant="outline" render={<Link href={`/governance/${props.code}`} />}>
