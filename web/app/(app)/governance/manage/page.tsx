...
import { OrgRoleAssignmentForm } from "@/app/(app)/governance/manage/_components/org-role-assignment-form"
import { RevokeOrgRoleButton } from "@/app/(app)/governance/manage/_components/revoke-org-role-button"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "規程・手続き", href: "/governance" }, { label: "整合性管理" }]}
      />
                ...
                {impact.issues.map((issue) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {issue.document_code ? (
                        <Link
                          href={`/governance/${issue.document_code}`}
