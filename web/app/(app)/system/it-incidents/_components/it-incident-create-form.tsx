...
import { createItIncidentAction } from "@/app/(app)/system/it-incidents/actions"
import type { ItIncidentActionState } from "@/app/(app)/system/it-incidents/actions"
...
export function ItIncidentCreateForm() {
  ...
  async function reduce(
    ...
    if (result.ok) {
      ...
      router.push("/system/it-incidents")
