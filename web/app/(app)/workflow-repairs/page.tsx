...
import { WorkflowRepairList } from "@/app/(app)/workflow-repairs/_components/workflow-repair-list"
...
export const metadata = { title: "承認経路の修復" }
...
export default async function WorkflowRepairsPage(props: Props) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title="承認経路の修復">
        <Button variant="secondary" nativeButton={false} render={<Link href="/applications" />}>
          申請管理へ
        </Button>
      </PageHeader>
