...
import { ResignationAdminActions } from "@/app/(app)/resignation/resignations/_components/resignation-admin-actions"
        ...
        <TableBody>
          {props.rows.map((row) => (
            <TableRow key={row.id}>
              <TableCell>
                <Link
                  href={`/resignation/resignations?employee_id=${row.employee_id}`}
