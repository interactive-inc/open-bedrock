...
vi.mock("@/app/(app)/audit-events/_components/audit-export-form", () => ({
  AuditExportForm: () => <div>CSV出力フォーム</div>,
}))
vi.mock("@/app/(app)/audit-events/_components/audit-event-list-section", () => ({
...
import AuditEventsPage from "@/app/(app)/audit-events/page"
