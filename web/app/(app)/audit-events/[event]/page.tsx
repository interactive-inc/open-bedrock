...
import { auditActionLabel } from "@/app/(app)/audit-events/_lib/audit-action-label"
import { auditClientLabel } from "@/app/(app)/audit-events/_lib/audit-client-label"
import { auditOutcomeLabel } from "@/app/(app)/audit-events/_lib/audit-outcome-label"
import { auditReasonLabel } from "@/app/(app)/audit-events/_lib/audit-reason-label"
import { auditTargetTypeLabel } from "@/app/(app)/audit-events/_lib/audit-target-type-label"
import { AuditJsonView } from "@/app/(app)/audit-events/_components/audit-json-view"
import { formatAuditDateTime } from "@/app/(app)/audit-events/_lib/format-audit-date-time"
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader title="監査イベント">
        <BackButton href="/audit-events" label="一覧に戻る" prefetch={false} />
      </PageHeader>
