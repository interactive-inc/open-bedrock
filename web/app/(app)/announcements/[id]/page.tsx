...
import { AnnouncementManageActions } from "@/app/(app)/announcements/[id]/_components/announcement-manage-actions"
...
export default async function AnnouncementDetailPage(props: Props) {
  ...
  const announcementId = toAnnouncementId(params.id)
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/announcements" label="一覧に戻る" />}
      />
