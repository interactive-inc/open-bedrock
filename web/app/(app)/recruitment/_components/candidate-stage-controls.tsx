...
import { advanceCandidateAction } from "@/app/(app)/recruitment/actions"
import type { RecruitmentActionState } from "@/app/(app)/recruitment/actions"
import {
  canReject,
  toCandidateStageLabel,
  toNextStage,
} from "@/app/(app)/recruitment/_lib/candidate-stage"
