...
import { CandidateStageControls } from "@/app/(app)/recruitment/_components/candidate-stage-controls"
import { toCandidateStageLabel } from "@/app/(app)/recruitment/_lib/candidate-stage"
  ...
  return (
    <div className="flex flex-col gap-3">
      {candidates.map((candidate) => (
        <Card key={candidate.id} className="gap-0 p-0">
