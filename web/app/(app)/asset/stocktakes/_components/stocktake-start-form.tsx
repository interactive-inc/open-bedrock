...
import { startStocktakeAction } from "@/app/(app)/asset/stocktakes/actions"
import type { StocktakeStartFormState } from "@/app/(app)/asset/stocktakes/actions"
...
export function StocktakeStartForm() {
  ...
  async function reduce(
    ...
    if (result.ok) {
      ...
      router.push(`/asset/stocktakes/${result.id}`)
