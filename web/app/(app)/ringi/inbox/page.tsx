...
import { RingiDecisionForm } from "@/app/(app)/ringi/_components/ringi-decision-form"
...
export default function RingiInboxPage() {
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="稟議の承認 inbox"
        description="承認待ちの稟議を確認します。"
        actions={
          <Button variant="outline" nativeButton={false} render={<Link href="/ringi" />}>
            自分の稟議へ
          </Button>
        }
      />
