...
import { RingiAdminFilterForm } from "@/app/(app)/ringi/admin/_components/ringi-admin-filter-form"
import { RingiAdminTable } from "@/app/(app)/ringi/admin/_components/ringi-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "稟議", href: "/ringi" }, { label: "稟議管理" }]}
        actions={
          <Button variant="outline" nativeButton={false} render={<Link href="/ringi/inbox" />}>
            承認受信箱
          </Button>
        }
      />
