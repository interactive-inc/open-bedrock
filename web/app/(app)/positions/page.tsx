...
import { PositionList } from "@/app/(app)/positions/_components/position-list"
...
export default async function PositionsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="役職"
        description="役職マスタの一覧です。従業員への付与は人事発令で行います。"
        actions={
          canManage ? (
            <Button nativeButton={false} render={<Link href="/positions/new" />}>
              <Plus />
              新規役職
            </Button>
          ) : null
