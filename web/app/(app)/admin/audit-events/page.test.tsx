...
vi.mock("@/app/(app)/admin/audit-events/_components/audit-export-form", () => ({
  AuditExportForm: () => <div>CSV出力フォーム</div>,
}))
vi.mock("@/app/(app)/admin/audit-events/_components/audit-event-list-section", () => ({
...
import AuditEventsPage from "@/app/(app)/admin/audit-events/page"
