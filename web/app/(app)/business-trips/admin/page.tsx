...
import { BusinessTripAdminFilterForm } from "@/app/(app)/business-trips/admin/_components/business-trip-admin-filter-form"
import { BusinessTripAdminTable } from "@/app/(app)/business-trips/admin/_components/business-trip-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "出張", href: "/business-trips" }, { label: "出張申請管理" }]}
        actions={
          <Button variant="outline" nativeButton={false} render={<Link href="/business-trips" />}>
            自分の申請
          </Button>
        }
      />
