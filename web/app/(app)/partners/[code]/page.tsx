...
import { PartnerContractsSection } from "@/app/(app)/partners/_components/partner-contracts-section"
import { PartnerStatusBadge } from "@/app/(app)/partners/_components/partner-status-badge"
import { partnerCategoryLabel } from "@/app/(app)/partners/_lib/partner-category-label"
...
export default async function PartnerDetailPage(props: Props) {
  ...
  const partner = await getPartnerByCode(params.code)
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title={partner.name}
        actions={<BackButton href="/partners" label="一覧に戻る" />}
      />
