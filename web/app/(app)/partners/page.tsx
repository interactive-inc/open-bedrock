...
import { PartnerFilterForm } from "@/app/(app)/partners/_components/partner-filter-form"
...
export default async function PartnersPage(props: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="取引先"
        description="キーワード・状態で絞り込み、取引先の一覧を確認します。"
        actions={
          canManage ? (
            <Button nativeButton={false} render={<Link href="/partners/new" />}>
              取引先を登録
            </Button>
          ) : null
        }
