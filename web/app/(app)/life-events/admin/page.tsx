...
import { LifeEventAdminFilterForm } from "@/app/(app)/life-events/admin/_components/life-event-admin-filter-form"
import { LifeEventAdminTable } from "@/app/(app)/life-events/admin/_components/life-event-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "ライフイベント届", href: "/life-events" },
          { label: "ライフイベント届管理" },
        ]}
        actions={
          <Button variant="outline" nativeButton={false} render={<Link href="/life-events" />}>
            自分の届出
          </Button>
        }
      />
