...
import { createSurveyAction } from "@/app/(app)/survey/surveys/manage/actions"
import type { SurveyFormState } from "@/app/(app)/survey/surveys/manage/actions"
...
export function SurveyCreateForm() {
  ...
  async function reduce(
    ...
    if (result.ok) {
      ...
      router.push("/survey/surveys/manage")
