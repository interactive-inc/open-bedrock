...
import { toPercentLabel } from "@/app/(app)/dashboards/management/_lib/to-percent-label"
import type { GoalDoneRate } from "@/app/(app)/dashboards/management/_lib/management-dashboard-types"
