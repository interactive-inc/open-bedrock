...
import { ThanksExchangeBalance } from "@/app/(app)/organization/thanks/_components/thanks-exchange-balance"
import { ThanksRewards } from "@/app/(app)/organization/thanks/_components/thanks-rewards"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <>
            <BackButton href="/organization/thanks" label="感謝に戻る" />
