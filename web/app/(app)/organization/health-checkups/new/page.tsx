...
import { HealthCheckupCreateForm } from "@/app/(app)/organization/health-checkups/_components/health-checkup-create-form"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/health-checkups" label="一覧に戻る" />}
      />
