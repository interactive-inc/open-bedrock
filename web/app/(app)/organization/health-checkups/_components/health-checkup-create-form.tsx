...
import { createHealthCheckupAction } from "@/app/(app)/organization/health-checkups/actions"
import type { HealthCheckupActionState } from "@/app/(app)/organization/health-checkups/actions"
...
export function HealthCheckupCreateForm(props: Props) {
  ...
  async function reduce(
    ...
    if (result.ok) {
      ...
      router.push("/organization/health-checkups")
