...
import { EmployeeDetail } from "@/app/(app)/organization/employees/[employee]/_components/employee-detail"
import { EmployeeEventHistory } from "@/app/(app)/organization/employees/[employee]/_components/employee-event-history"
import { EmployeeGradeHistory } from "@/app/(app)/organization/employees/[employee]/_components/employee-grade-history"
import { EmployeeSalaryRevisionHistory } from "@/app/(app)/organization/employees/[employee]/_components/employee-salary-revision-history"
import { EmployeeWorkStyleHistory } from "@/app/(app)/organization/employees/[employee]/_components/employee-work-style-history"
...
export default async function EmployeeDetailPage(props: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="従業員詳細"
        actions={<BackButton href="/organization/employees" label="一覧に戻る" />}
      />
