...
import { OnboardingEmployeeView } from "@/app/(app)/organization/employees/[employee]/onboarding/_components/onboarding-employee-view"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <BackButton href="/organization/onboarding-assignments" label="オンボーディングに戻る" />
        }
      />
