...
import { CandidateNewForm } from "@/app/(app)/organization/recruitments/_components/candidate-new-form"
import { CandidatePipeline } from "@/app/(app)/organization/recruitments/_components/candidate-pipeline"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "採用", href: "/organization/recruitments" },
          { label: "応募者パイプライン" },
        ]}
      />
