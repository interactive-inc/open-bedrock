...
import { CertificateRequestAdminFilterForm } from "@/app/(app)/organization/certificate-requests/_components/certificate-request-admin-filter-form"
import { CertificateRequestAdminTable } from "@/app/(app)/organization/certificate-requests/_components/certificate-request-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "証明書発行依頼", href: "/organization/certificate-requests" },
          { label: "証明書発行依頼管理" },
        ]}
        actions={
          <Button
...
async function CertificateRequestAdminSection(props: {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <TablePagination
        pathname="/organization/certificate-requests"
        total={result.total}
        limit={PAGE_SIZE}
        offset={props.offset}
