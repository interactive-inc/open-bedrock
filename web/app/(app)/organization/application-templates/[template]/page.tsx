...
import { SubmitApplicationForm } from "@/app/(app)/organization/application-templates/[template]/_components/submit-application-form"
import { TemplateManagement } from "@/app/(app)/organization/application-templates/_components/template-management"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/application-templates" label="テンプレ一覧へ" />}
      />
