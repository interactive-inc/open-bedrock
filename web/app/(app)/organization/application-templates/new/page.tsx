...
import { CreateTemplateForm } from "@/app/(app)/organization/application-templates/_components/create-template-form"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/application-templates" label="一覧に戻る" />}
      />
