...
import { PositionList } from "@/app/(app)/organization/positions/_components/position-list"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          canManage ? (
            <Button nativeButton={false} render={<Link href="/organization/positions/new" />}>
              <Plus />
              新規役職
            </Button>
          ) : null
