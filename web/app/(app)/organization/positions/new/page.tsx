...
import { PositionCreateForm } from "@/app/(app)/organization/positions/_components/position-create-form"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/positions" label="役職に戻る" />}
      />
