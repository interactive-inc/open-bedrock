...
import { deletePositionAction } from "@/app/(app)/organization/positions/actions"
import { PositionEditForm } from "@/app/(app)/organization/positions/_components/position-edit-form"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            この操作は取り消せません。役職マスタの記録が完全に削除されます。従業員が現に使っている役職は削除できません。
          </AlertDialogDescription>
        </AlertDialogHeader>
