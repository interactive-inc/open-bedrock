...
import { OnboardingTemplatesTable } from "@/app/(app)/organization/onboarding-assignments/_components/onboarding-templates-table"
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button
              nativeButton={false}
              render={<Link href="/organization/onboarding-templates/new" />}
            >
              <Plus />
              新規テンプレート
            </Button>
