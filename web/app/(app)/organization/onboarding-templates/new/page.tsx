...
import { CreateTemplateForm } from "@/app/(app)/organization/onboarding-assignments/_components/create-template-form"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/onboarding-assignments" label="一覧に戻る" />}
      />
