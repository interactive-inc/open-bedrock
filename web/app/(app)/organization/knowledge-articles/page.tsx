...
import { KnowledgeResultList } from "@/app/(app)/organization/knowledge-articles/_components/knowledge-result-list"
    ...
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <Button
            nativeButton={false}
            render={<Link href="/organization/knowledge-articles/new" />}
          >
            <Plus />
            新規記事
          </Button>
      ...
      >
        <KnowledgeResultList q={q} category={category} offset={offset} pageSize={pageSize} />
      </Suspense>
    </div>
  )
}
