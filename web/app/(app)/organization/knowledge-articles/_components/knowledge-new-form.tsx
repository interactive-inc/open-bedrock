...
import { createKnowledgeAction } from "@/app/(app)/organization/knowledge-articles/actions"
import type { KnowledgeActionState } from "@/app/(app)/organization/knowledge-articles/actions"
...
export function KnowledgeNewForm() {
  ...
  const action = useFormAction(createKnowledgeAction, initialState, "ナレッジを作成しました", {
    onSuccess: () => router.push("/organization/knowledge-articles"),
  })
