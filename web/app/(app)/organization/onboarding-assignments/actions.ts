...
export async function assignOnboardingAction(
  ...
  revalidatePath(`/organization/employees/${employeeCode}/onboarding`)

  revalidatePath("/organization/onboarding-assignments")

  revalidatePath("/organization/onboarding-assignments/new")
