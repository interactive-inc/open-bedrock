...
import { sendThanksAction } from "@/app/(app)/organization/thanks/actions"
import type { ThanksActionState } from "@/app/(app)/organization/thanks/actions"
import { searchRecipientsAction } from "@/app/(app)/organization/thanks/search-recipients-action"
...
export function ThanksCreateForm() {
  ...
  async function reduce(
    ...
    if (result.ok) {
      ...
      router.push("/organization/thanks")
      setRecipient(null)
