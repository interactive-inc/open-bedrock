...
import { ResignationAdminFilterForm } from "@/app/(app)/organization/resignations/_components/resignation-admin-filter-form"
import { ResignationAdminTable } from "@/app/(app)/organization/resignations/_components/resignation-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "退職手続き", href: "/organization/resignations" },
          { label: "退職手続き管理" },
        ]}
        actions={
          <Button
            variant="outline"
            nativeButton={false}
            render={<Link href="/organization/resignations" />}
          >
            自分の手続き
          </Button>
        }
...
async function ResignationAdminSection(props: {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <TablePagination
        pathname="/organization/resignations"
        total={result.total}
        limit={PAGE_SIZE}
        offset={props.offset}
