...
import { PartnerFilterForm } from "@/app/(app)/organization/partners/_components/partner-filter-form"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          canManage ? (
            <Button nativeButton={false} render={<Link href="/organization/partners/new" />}>
              取引先を登録
            </Button>
          ) : null
        }
        ...
        <TableBody>
          {partners.map((partner) => (
            <TableRow key={partner.code}>
              <TableCell>
                <Link
                  href={`/organization/partners/${partner.code}`}
