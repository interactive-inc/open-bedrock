  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <>
            <BackButton href="/organization/assets" label="備品に戻る" />

            <Button nativeButton={false} render={<Link href="/organization/stocktakes/new" />}>
              棚卸しを開始
            </Button>
          </>
        }
        ...
        <TableBody>
          {stocktakes.map((stocktake) => (
            <TableRow key={stocktake.id}>
              <TableCell>
                <Link
                  href={`/organization/stocktakes/${stocktake.id}`}
