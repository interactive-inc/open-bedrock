...
import { AnnouncementManageActions } from "@/app/(app)/organization/announcements/[announcement]/_components/announcement-manage-actions"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/announcements" label="一覧に戻る" />}
      />
