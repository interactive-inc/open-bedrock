...
import { AnnouncementCreateForm } from "@/app/(app)/organization/announcements/_components/announcement-create-form"
        ...
        <TableBody>
          {announcements.map((announcement) => (
            <TableRow key={announcement.id}>
              <TableCell>
                <Link
                  href={`/organization/announcements/${announcement.id}`}
