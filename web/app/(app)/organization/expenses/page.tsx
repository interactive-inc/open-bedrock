...
import { ExpenseAdminFilterForm } from "@/app/(app)/organization/expenses/_components/expense-admin-filter-form"
import { ExpenseAdminTable } from "@/app/(app)/organization/expenses/_components/expense-admin-table"
...
async function ExpenseAdminSection(props: {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <TablePagination
        pathname="/organization/expenses"
        total={result.total}
        limit={props.pageSize}
        offset={props.offset}
