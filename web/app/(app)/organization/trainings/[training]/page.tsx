...
import { EnrollButton } from "@/app/(app)/organization/trainings/_components/enroll-button"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          <>
            <BackButton href="/organization/trainings" label="一覧に戻る" />

            {canManage ? (
              <Button
                variant="outline"
                nativeButton={false}
                render={<Link href={`/organization/trainings/${course.code}/edit`} />}
              >
                編集
              </Button>
            ) : null}
