...
import { ArchiveCourseButton } from "@/app/(app)/organization/trainings/[training]/edit/_components/archive-course-button"
import { UpdateCourseForm } from "@/app/(app)/organization/trainings/[training]/edit/_components/update-course-form"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href={`/organization/trainings/${course.code}`} label="詳細に戻る" />}
      />
