...
import { CourseList } from "@/app/(app)/organization/trainings/_components/course-list"
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            {canManage ? (
              <Button nativeButton={false} render={<Link href="/organization/trainings/new" />}>
                <Plus />
                新規コース
              </Button>
            ) : null}
...
async function Courses(props: { offset: number; pageSize: number }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <TablePagination
        pathname="/organization/trainings"
        total={result.total}
