...
import { DocumentWorkflowActions } from "@/app/(app)/organization/governance/[code]/_components/document-workflow-actions"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/governance" label="一覧に戻る" />}
      />
...
function ReferenceBadge(props: { kind: string; code: string }) {
  if (
    ...
    return (
      <Badge variant="outline" render={<Link href={`/organization/governance/${props.code}`} />}>
