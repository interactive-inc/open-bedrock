...
export async function createSurveyAction(
  ...
  revalidatePath("/organization/surveys")
  revalidatePath("/organization/surveys/manage")
...
export async function updateSurveyAction(
  ...
  revalidatePath("/organization/surveys")
  revalidatePath("/organization/surveys/manage")
  revalidatePath(`/organization/surveys/${surveyId}`)
  revalidatePath(`/organization/surveys/${surveyId}/edit`)
  revalidatePath(`/organization/surveys/${surveyId}/summary`)
