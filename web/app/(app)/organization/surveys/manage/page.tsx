...
import { SurveyDeleteButton } from "@/app/(app)/organization/surveys/manage/_components/survey-delete-button"
        ...
        actions={
          <>
            <Button
              variant="outline"
              nativeButton={false}
              render={<Link href="/organization/surveys" />}
            >
              サーベイ一覧へ
            </Button>

            <Button nativeButton={false} render={<Link href="/organization/surveys/manage/new" />}>
              <Plus />
              新規アンケート
            </Button>
          </>
              ...
              <TableCell>
                <TableRowActions>
                  <Button
                    ...
                    size="sm"
                    nativeButton={false}
                    render={<Link href={`/organization/surveys/${survey.id}/edit`} />}
                  >
                    編集
                  </Button>
