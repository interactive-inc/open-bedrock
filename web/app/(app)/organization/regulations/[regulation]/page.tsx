...
import { RegulationManageActions } from "@/app/(app)/organization/regulations/[regulation]/_components/regulation-manage-actions"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/organization/regulations" label="一覧に戻る" />}
      />
