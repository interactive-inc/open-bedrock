...
import { BusinessTripAdminActions } from "@/app/(app)/organization/business-trips/_components/business-trip-admin-actions"
          ...
          {props.rows.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell className="text-muted-foreground">
                <Link
                  href={`/organization/business-trips?employee_id=${row.traveler_id}`}
