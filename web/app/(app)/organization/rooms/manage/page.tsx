...
import { RoomDeleteButton } from "@/app/(app)/organization/rooms/manage/_components/room-delete-button"
import { RoomEditForm } from "@/app/(app)/organization/rooms/manage/_components/room-edit-form"
        ...
        actions={
          <>
            <Button
              variant="outline"
              nativeButton={false}
              render={<Link href="/organization/rooms" />}
            >
              予約・空き状況へ
            </Button>

            <Button nativeButton={false} render={<Link href="/organization/rooms/manage/new" />}>
              <Plus />
              会議室を登録
            </Button>
          </>
