...
import { BudgetSummaryFilterForm } from "@/app/(app)/organization/budgets/summary/_components/budget-summary-filter-form"
...
// GET /budgets/summary を認証付きで取得して部署ごとの消化状況テーブルを描画する非同期 RSC。
