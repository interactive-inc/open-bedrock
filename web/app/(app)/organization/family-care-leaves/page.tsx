...
import { FamilyCareLeaveAdminFilterForm } from "@/app/(app)/organization/family-care-leaves/_components/family-care-leave-admin-filter-form"
import { FamilyCareLeaveAdminTable } from "@/app/(app)/organization/family-care-leaves/_components/family-care-leave-admin-table"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "産休・育休・介護", href: "/organization/family-care-leaves" },
          { label: "産休・育休・介護休業管理" },
        ]}
        actions={
          <Button
...
async function FamilyCareLeaveAdminSection(props: {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <TablePagination
        pathname="/organization/family-care-leaves"
        total={result.total}
        limit={PAGE_SIZE}
        offset={props.offset}
