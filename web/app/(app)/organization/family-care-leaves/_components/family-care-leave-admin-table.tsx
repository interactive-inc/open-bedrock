...
import { FamilyCareLeaveAdminActions } from "@/app/(app)/organization/family-care-leaves/_components/family-care-leave-admin-actions"
          ...
          {props.rows.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell className="text-muted-foreground">
                <Link
                  href={`/organization/family-care-leaves?employee_id=${row.employee_id}`}
