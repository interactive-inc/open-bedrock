...
import { DecisionList } from "@/app/(app)/organization/decisions/_components/decision-list"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={
          canManage ? (
            <Button nativeButton={false} render={<Link href="/organization/decisions/new" />}>
              <Plus />
              記録を作成
            </Button>
          ) : null
