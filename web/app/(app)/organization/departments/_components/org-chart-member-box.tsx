...
export function OrgChartMemberBox(props: Props) {
  return (
    <Link
      href={`/organization/employees/${props.member.employee_code}/reporting-line`}
      className={cn(
        "flex items-center gap-1.5 rounded-md border px-2.5 py-1 text-xs hover:bg-muted/50",
