import { OrgDepartmentManagerList } from "@/app/(app)/organization/departments/_components/org-department-manager-list"
import { FetchError } from "@/components/fetch-error"
import { listOrgDepartments } from "@/lib/api/list-org-departments"

/** 部署ノード管理セクション（GET /departments）。取得失敗時はメッセージを表示する。 */
