...
import { AssetFilterForm } from "@/app/(app)/organization/assets/_components/asset-filter-form"
            ...
            {canManage ? (
              <>
                <Button
                  variant="outline"
                  nativeButton={false}
                  render={<Link href="/organization/assets/holdings" />}
                >
                  保有状況
                </Button>
                ...
                <Button
                  variant="outline"
                  nativeButton={false}
                  render={<Link href="/organization/stocktakes" />}
                >
                  棚卸し
                </Button>

                <Button nativeButton={false} render={<Link href="/organization/assets/new" />}>
                  物品を登録
                </Button>
              </>
            ) : null}
