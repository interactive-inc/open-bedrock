import { StocktakeCheckForm } from "@/app/(app)/stocktakes/_components/stocktake-check-form"
import { StocktakeCloseButton } from "@/app/(app)/stocktakes/_components/stocktake-close-button"
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/stocktakes" label="一覧に戻る" />}
      />
