...
import { RegulationManageActions } from "@/app/(app)/regulations/[code]/_components/regulation-manage-actions"
...
export default async function RegulationDetailPage(props: Props) {
  ...
  const regulation = await getRegulationDetail(params.code)
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        actions={<BackButton href="/regulations" label="一覧に戻る" />}
      />
