...
export const urlRedirects: ReadonlyArray<Redirect> = [
  ...
  { source: "/teams/reports", destination: "/company/direct-reports", permanent: false },
  ...
  // --- マイチームと代理承認は部署空間へ移動 ---
  { source: "/my/reports", destination: "/company/direct-reports", permanent: false },
  {
    source: "/my/approval-delegations",
    destination: "/teams/approval-delegations",
    permanent: false,
  },
  { source: "/me/reports", destination: "/company/direct-reports", permanent: false },
  // --- 空間 prefix の廃止（第3世代） ---
  ...
  // 「レポート」と誤読されるため direct reports（直属の部下）へ改名した。
  { source: "/company/reports", destination: "/company/direct-reports", permanent: false },
