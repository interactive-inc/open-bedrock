...
/** GET /company/profile。LegalEntity と CompanyProfile を返す。 */
export async function getCompanyProfileResources(): Promise<CompanyResourceList | Error> {
  ...
  if (response.status >= 400) {
    return new Error("failed to load company profile")
  }
