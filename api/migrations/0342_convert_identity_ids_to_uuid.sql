...
SELECT source.id,
       ...
       CASE WHEN json_valid(source.source_json) AND json_type(source.source_json) = 'object' THEN json_replace(source.source_json, '$.accountId', COALESCE((SELECT m.new_id FROM _system_accounts_id_map m WHERE m.old_id = json_extract(source.source_json, '$.accountId')), json_extract(source.source_json, '$.accountId')), '$.actorAccountId', COALESCE((SELECT m.new_id FROM _system_accounts_id_map m WHERE m.old_id = json_extract(source.source_json, '$.actorAccountId')), json_extract(source.source_json, '$.actorAccountId')), '$.release.actorAccountId', COALESCE((SELECT m.new_id FROM _system_accounts_id_map m WHERE m.old_id = json_extract(source.source_json, '$.release.actorAccountId')), json_extract(source.source_json, '$.release.actorAccountId')), '$.employeeId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.employeeId')), json_extract(source.source_json, '$.employeeId')), '$.managerEmployeeId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.managerEmployeeId')), json_extract(source.source_json, '$.managerEmployeeId')), '$.targetEmployeeId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.targetEmployeeId')), json_extract(source.source_json, '$.targetEmployeeId')), '$.requestedByEmployeeId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.requestedByEmployeeId')), json_extract(source.source_json, '$.requestedByEmployeeId')), '$.requestedApproverId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.requestedApproverId')), json_extract(source.source_json, '$.requestedApproverId')), '$.applicantId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.applicantId')), json_extract(source.source_json, '$.applicantId')), '$.holderId', COALESCE((SELECT m.new_id FROM _company_employees_id_map m WHERE m.old_id = json_extract(source.source_json, '$.holderId')), (SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.holderId')), json_extract(source.source_json, '$.holderId')), '$.personId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.personId')), json_extract(source.source_json, '$.personId')), '$.employmentId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.employmentId')), json_extract(source.source_json, '$.employmentId')), '$.periodId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.periodId')), json_extract(source.source_json, '$.periodId')), '$.resourceId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.resourceId')), json_extract(source.source_json, '$.resourceId')), '$.existingResourceId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.existingResourceId')), json_extract(source.source_json, '$.existingResourceId')), '$.scopeId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.scopeId')), json_extract(source.source_json, '$.scopeId')), '$.authorityScopeId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.authorityScopeId')), json_extract(source.source_json, '$.authorityScopeId')), '$.responsibilityId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.responsibilityId')), json_extract(source.source_json, '$.responsibilityId')), '$.collectiveBodyId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.collectiveBodyId')), json_extract(source.source_json, '$.collectiveBodyId')), '$.organizationalOfficeId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.organizationalOfficeId')), json_extract(source.source_json, '$.organizationalOfficeId')), '$.positionId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.positionId')), json_extract(source.source_json, '$.positionId')), '$.jobId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.jobId')), json_extract(source.source_json, '$.jobId')), '$.siteId', COALESCE((SELECT m.new_id FROM _f_misc_id_map m WHERE m.old_id = json_extract(source.source_json, '$.siteId')), json_extract(source.source_json, '$.siteId'))) ELSE source.source_json END ,
       source.recorded_at,
