import { createAssetPreservationDecisionHandlers } from "@/contexts/asset/interface/operations/create-asset-preservation-decision-handlers"
...
export const POST = assetFactory.createHandlers(
  ...
  ...createAssetPreservationDecisionHandlers("approve"),
)
