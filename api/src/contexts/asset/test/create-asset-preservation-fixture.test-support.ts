...
const secret = "asset-integration-test-secret"

/** 実System・Companyと資産4台帳の原記録を接続する保全fixture。 */
export async function createAssetPreservationFixture(database: D1Database) {
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "asset-pagination-test-pepper",
