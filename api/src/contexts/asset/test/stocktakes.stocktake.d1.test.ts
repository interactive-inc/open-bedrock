...
import { seedStocktakeItems } from "@/contexts/asset/test/seed/seed-stocktake-items.test-support"
import { seedStocktakes } from "@/contexts/asset/test/seed/seed-stocktakes.test-support"
...
beforeAll(async () => {
  pool = await startLocalD1Pool(15)
})
