...
import { seedAntisocialChecks } from "@/contexts/antisocial-check/infrastructure/seed/seed-antisocial-checks"
...
import * as createRoute from "@/contexts/antisocial-check/interface/routes/antisocial-checks/route"
import * as detailRoute from "@/contexts/antisocial-check/interface/routes/antisocial-checks/[id]/route"
import * as meRoute from "@/contexts/antisocial-check/interface/routes/antisocial-checks/me/route"
import * as adminRoute from "@/contexts/antisocial-check/interface/routes/antisocial-checks/admin/route"
import { z } from "zod"
...
describe("GET /antisocial-checks/me", () => {
  test("returns only the viewer's antisocial checks", async () => {
    ...
    const parsed = z
      .object({ data: z.array(antisocialCheckResponseSchema), total: z.number() })
