import { createAntisocialCheckRetirementDecisionHandlers } from "@/contexts/antisocial-check/interface/operations/create-antisocial-check-retirement-decision-handlers"
...
export const POST = antisocialCheckFactory.createHandlers(
  ...
  ...createAntisocialCheckRetirementDecisionHandlers("approve"),
)
