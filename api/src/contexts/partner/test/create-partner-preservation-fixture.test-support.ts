...
const secret = "partner-integration-test-secret"

/** 実System・Companyと取引先2台帳の原記録を接続する保全fixture。 */
export async function createPartnerPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "partner-preservation",
    revision: 1,
    title: "Preserve partner records",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "partner-pagination-test-pepper",
