import { createPartnerPreservationDecisionHandlers } from "@/contexts/partner/interface/operations/create-partner-preservation-decision-handlers"
...
export const POST = partnerFactory.createHandlers(
  ...
  ...createPartnerPreservationDecisionHandlers("approve"),
)
