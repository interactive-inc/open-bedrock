...
const jwtSecret = "rental-lend-route-test-secret"
...
describe("POST /rental-reservations/:id/lend", () => {
  test("returns 200 and marks the reservation lent for hr", async () => {
  ...
  test("returns 409 when lending an already-lent reservation", async () => {
