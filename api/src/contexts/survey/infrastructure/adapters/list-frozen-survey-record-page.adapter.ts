...
export class ListFrozenSurveyRecordPageAdapter {
  ...
  async prepare(input: unknown) {
    ...
    try {
      ...
      return new Error("frozen survey inventory unavailable", { cause })
    }
  }
}
