...
test("アンケート・回答記録を全件保全し、人の承認を経て2台帳を撤去確定する", async () => {
  ...
  await execSql(
    database,
    "INSERT INTO system_iam_role_permissions(role_id,permission_key) VALUES ('066fe97a-a8a2-48fe-8779-38d87db67977','system:record:export'); DROP TABLE survey_responses; DROP TABLE surveys;",
  )
