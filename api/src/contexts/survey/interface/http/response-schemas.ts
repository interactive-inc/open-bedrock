...
export const surveySourceFreezeResponseSchema = z.strictObject({
...
export const zAppSurveyRetirementPlan = z.strictObject({
  ...
  recordKinds: z.array(surveyRecordKindSchema).length(2),
...
export const zAppSurveyRetirementExecution = z.strictObject({
