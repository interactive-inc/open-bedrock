import { createSurveyPreservationDecisionHandlers } from "@/contexts/survey/interface/operations/create-survey-preservation-decision-handlers"
...
export const POST = surveyFactory.createHandlers(
  ...
  ...createSurveyPreservationDecisionHandlers("approve"),
)
