...
export class ExecuteResignationRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new ResignationRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new ResignationRetirementConflictError("retirement verified scope differs")
    ...
    if (finalized instanceof Error) {
      ...
      return new ResignationRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
