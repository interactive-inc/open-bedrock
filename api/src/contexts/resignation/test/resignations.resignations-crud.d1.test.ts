...
beforeAll(async () => {
  pool = await startLocalD1Pool(21)
})
...
const ownResignationId = "20000000-0000-4000-8000-000000000002"

const othersResignationId = "20000000-0000-4000-8000-000000000001"
