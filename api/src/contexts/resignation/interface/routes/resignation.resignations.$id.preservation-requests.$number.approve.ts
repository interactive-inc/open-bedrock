import { createResignationPreservationDecisionHandlers } from "@/contexts/resignation/interface/operations/create-resignation-preservation-decision-handlers"
...
export const POST = resignationFactory.createHandlers(
  ...
  ...createResignationPreservationDecisionHandlers("approve"),
)
