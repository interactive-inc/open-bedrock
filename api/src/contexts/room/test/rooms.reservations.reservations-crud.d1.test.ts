...
const ownReservationId = "00000000-0000-4000-8000-000000000002"

const othersReservationId = "00000000-0000-4000-8000-000000000001"
...
describe("GET /rooms/reservations/me", () => {
  test("returns only the viewer's reservations", async () => {
    ...
    if (parsed.success) {
      ...
      expect(parsed.data.data[0].reserver_id).toBe(toWorkforceEmployeeId(testEmployeeId(4)))
    }
  })
