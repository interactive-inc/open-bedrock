...
/** 実System・Companyと会議室2台帳の原記録を接続する保全fixture。 */
export async function createRoomPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "room-preservation",
    revision: 1,
    title: "Preserve room records",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
