import { zAppRoomRetirementExecution } from "@/contexts/room/interface/http/response-schemas"
import { z } from "zod"
import { zValidator } from "@hono/zod-validator"
import { roomFactory } from "@/contexts/room/interface/request-environment/room-factory"
import { ExecuteRoomRetirementAdapter } from "@/contexts/room/infrastructure/adapters/execute-room-retirement.adapter"
import {
...
export const POST = roomFactory.createHandlers(
  ...
  async (c) => {
    ...
    const submitted = await new ExecuteRoomRetirementAdapter(c).execute(
      {
    ...
    return c.json(zAppRoomRetirementExecution.parse(submitted), 200)
  },
)
