...
const secret = "headcount-plan-integration-test-secret"

/** 実System・Companyと人員計画原記録を接続する保全fixture。 */
export async function createHeadcountPlanPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "headcount-plan-preservation",
    revision: 1,
    title: "Preserve headcount-plans",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "headcount-plan-pagination-test-pepper",
