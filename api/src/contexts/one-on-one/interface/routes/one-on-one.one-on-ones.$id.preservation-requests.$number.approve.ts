import { createOneOnOnePreservationDecisionHandlers } from "@/contexts/one-on-one/interface/operations/create-one-on-one-preservation-decision-handlers"
...
export const POST = oneOnOneFactory.createHandlers(
  ...
  ...createOneOnOnePreservationDecisionHandlers("approve"),
)
