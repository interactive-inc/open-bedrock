...
export const oneOnOneSourceFreezeResponseSchema = z.strictObject({ freeze: recordSourceFreezeSnapshotSchema })
...
export const zAppOneOnOneRetirementPlan = z.strictObject({
  ...
  totalPages: z.number().int().positive().safe(), recordKinds: z.array(z.literal("one-on-one-record")),
