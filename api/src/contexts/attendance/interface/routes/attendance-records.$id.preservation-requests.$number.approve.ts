import { createAttendancePreservationDecisionHandlers } from "@/contexts/attendance/interface/operations/create-attendance-preservation-decision-handlers"
...
export const POST = attendanceFactory.createHandlers(
  ...
  ...createAttendancePreservationDecisionHandlers("approve"),
)
