...
export class ExecuteAttendanceRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new AttendanceRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new AttendanceRetirementConflictError("retirement verified scope differs")
    ...
    if (proposal.status !== "approved")
      return new AttendanceRetirementConflictError("retirement is not approved")
    ...
    if (finalized instanceof Error) {
      ...
      return new AttendanceRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
