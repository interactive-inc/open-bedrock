...
test("11件の打刻を全件保全し、人の承認・取消・再提出を経て原記録を残して撤去確定する", async () => {
  ...
  await execSql(
    ...
    ('7cc94037-9f57-4c5b-8211-7c6c0e372ca5','system:admin'),
    ('7cc94037-9f57-4c5b-8211-7c6c0e372ca5','system:record:preserve'),
    ('7cc94037-9f57-4c5b-8211-7c6c0e372ca5','system:record:read'),
  ...
  await execSql(f.database, "DROP TRIGGER fail_attendance_retirement")
