...
const secret = "business-trip-integration-test-secret"

/** 実System・Companyと出張申請原記録を接続する保全fixture。 */
export async function createBusinessTripPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "business-trip-preservation",
    revision: 1,
    title: "Preserve business-trips",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "business-trip-pagination-test-pepper",
