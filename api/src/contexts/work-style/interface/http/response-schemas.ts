...
export const employeeWorkStyleSourceFreezeResponseSchema = z.strictObject({ freeze: recordSourceFreezeSnapshotSchema })
...
export const zAppEmployeeWorkStyleRetirementPlan = z.strictObject({
  ...
  totalPages: z.number().int().positive().safe(), recordKinds: z.array(z.literal("employee-work-style-record")),
