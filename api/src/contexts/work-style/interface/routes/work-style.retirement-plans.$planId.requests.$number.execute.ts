import { zAppEmployeeWorkStyleRetirementExecution } from "@/contexts/work-style/interface/http/response-schemas"
import { z } from "zod"
import { zValidator } from "@hono/zod-validator"
import { employeeWorkStyleFactory } from "@/contexts/work-style/interface/request-environment/work-style-factory"
import { ExecuteEmployeeWorkStyleRetirementAdapter } from "@/contexts/work-style/infrastructure/adapters/execute-work-style-retirement.adapter"
import {
...
export const POST = employeeWorkStyleFactory.createHandlers(
  ...
  async (c) => {
    ...
    const submitted = await new ExecuteEmployeeWorkStyleRetirementAdapter(c).execute(
      {
    ...
    return c.json(zAppEmployeeWorkStyleRetirementExecution.parse(submitted), 200)
  },
)
