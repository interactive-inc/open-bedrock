...
import { VerifyEmployeeWorkStyleRetirementPage } from "@/contexts/work-style/application/verify-employee-work-style-retirement-page"
...
import { zAppEmployeeWorkStyleRetirementVerificationReceipt } from "@/contexts/work-style/interface/http/response-schemas"
...
export const POST = employeeWorkStyleFactory.createHandlers(
  ...
  async (c) => {
    ...
    const command = employeeWorkStyleRetirementVerificationCommandSchema.safeParse({
      ...c.req.valid("json"),
    ...
    return c.json(
      zAppEmployeeWorkStyleRetirementVerificationReceipt.parse({
