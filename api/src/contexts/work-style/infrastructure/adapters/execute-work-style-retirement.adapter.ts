...
export class ExecuteEmployeeWorkStyleRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new EmployeeWorkStyleRetirementConflictError("retirement proposal version differs")
    ...
    if (proposal.status !== "approved")
      return new EmployeeWorkStyleRetirementConflictError("retirement is not approved")
    ...
    if (finalized instanceof Error) {
      ...
      return new EmployeeWorkStyleRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
