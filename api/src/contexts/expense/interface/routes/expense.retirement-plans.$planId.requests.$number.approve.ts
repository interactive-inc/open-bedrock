import { createExpenseRetirementDecisionHandlers } from "@/contexts/expense/interface/operations/create-expense-retirement-decision-handlers"
...
export const POST = expenseFactory.createHandlers(
  ...
  ...createExpenseRetirementDecisionHandlers("approve"),
)
