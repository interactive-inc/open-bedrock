import { createOnboardingPreservationDecisionHandlers } from "@/contexts/onboarding/interface/operations/create-onboarding-preservation-decision-handlers"
...
export const POST = onboardingFactory.createHandlers(
  ...
  ...createOnboardingPreservationDecisionHandlers("approve"),
)
