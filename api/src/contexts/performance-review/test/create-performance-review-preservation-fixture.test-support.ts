...
const secret = "performance-review-integration-test-secret"

/** 実System・Companyと人事評価8台帳の原記録を接続する保全fixture。 */
export async function createPerformanceReviewPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "performance-review-preservation",
    revision: 1,
    title: "Preserve performance-review records",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "performance-review-pagination-test-pepper",
