import { createPerformanceReviewRetirementDecisionHandlers } from "@/contexts/performance-review/interface/operations/create-performance-review-retirement-decision-handlers"
...
export const POST = performanceReviewFactory.createHandlers(
  ...
  ...createPerformanceReviewRetirementDecisionHandlers("approve"),
)
