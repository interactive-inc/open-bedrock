import { createShiftPreservationDecisionHandlers } from "@/contexts/shift/interface/operations/create-shift-preservation-decision-handlers"
...
export const POST = shiftFactory.createHandlers(
  ...
  ...createShiftPreservationDecisionHandlers("approve"),
)
