import { buildDepartmentTree } from "@/contexts/administration/interface/http/departments/tree/build-department-tree"
import type { DepartmentTreeNode } from "@/contexts/administration/interface/http/departments/tree/department-tree-node"
import { OrgDepartment } from "@/contexts/administration/domain/entities/org-department.entity"
import { factory } from "@/api/http/factory"
import { verifyBearer } from "@/api/http/verify-bearer"
import { UnauthorizedError } from "@/lib/http/errors"
import { MAX_ORG_NODES } from "@/lib/http/to-bounded-int"
