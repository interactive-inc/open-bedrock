import { CreateEmployeeEvent } from "@/contexts/administration/application/employee-event/create-employee-event"
import { canReadEmployeeEventsOf } from "@/contexts/administration/interface/http/employee-events/can-read-employee-events-of"
...
export const GET = factory.createHandlers(verifyBearer, async (c) => {
  ...
  const total = await repository.countByEmployeeId({
    employeeId: targetEmployeeId,
    kind,
  })
