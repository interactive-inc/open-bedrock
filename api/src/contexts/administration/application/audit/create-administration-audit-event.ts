...
import {
  ...
  createAdministrationAuditRecord,
} from "@/contexts/administration/application/audit/create-administration-audit-record"
import type {
  AuditJsonValue,
  AuditClientName,
  AuditOutcome,
...
export type AuditEventRecord = AdministrationAuditRecord &
  Readonly<{ actorEmployeeId: number | null }>
export type AuditEventSummary = AdministrationAuditSummary &
  Readonly<{ actorEmployeeId: number | null }>
export type AuditEventDetail = AdministrationAuditDetail &
  Readonly<{ actorEmployeeId: number | null }>
...
export function createAdministrationAuditEvent(
  ...
  const record = createAdministrationAuditRecord(
    {
