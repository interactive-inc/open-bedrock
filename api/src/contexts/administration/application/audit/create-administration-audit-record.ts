...
export type AdministrationAuditRecord = Readonly<{
  eventId: string
  requestId: string
...
export type AdministrationAuditRecordInput = Readonly<{
  actorAccountId: AccountId | null
  action: string
...
export type AdministrationAuditSummary = Readonly<{
  eventId: string
  requestId: string
  actorAccountId: AccountId | null
  action: string
...
export type AdministrationAuditDetail = AdministrationAuditSummary &
  Readonly<{
    authorizationJson: string | null
    beforeJson: string | null
    afterJson: string | null
...
export function createAdministrationAuditRecord(
  input: AdministrationAuditRecordInput,
