import { COMPANY_PERMISSION_KEYS } from "@/contexts/administration/domain/catalogs/company-permission-key.catalog"
import { SYSTEM_PERMISSION_KEYS } from "@system/domain/catalogs/iam/system-permission-key.catalog"
import { BUSINESS_PERMISSION_KEYS } from "@/contexts/administration/domain/catalogs/business-permission-key.catalog"
import { SYSTEM_CAPABILITY_PERMISSION_KEYS } from "@/contexts/administration/domain/catalogs/system-capability-permission-key.catalog"
import { z } from "zod"
