import { COMPANY_PERMISSION_KEYS } from "@/contexts/administration/domain/values/company-permission-key.catalog"
import { SYSTEM_PERMISSION_KEYS } from "@system/domain/values/system-permission-key.catalog"
import { BUSINESS_PERMISSION_KEYS } from "@/contexts/administration/domain/values/business-permission-key.catalog"
import { SYSTEM_CAPABILITY_PERMISSION_KEYS } from "@/contexts/administration/domain/values/system-capability-permission-key.catalog"
import { z } from "zod"
