import type {
  ...
  AuditEventSummary,
  AuditOutcome,
} from "@/contexts/administration/application/audit/create-administration-audit-event"
import {
...
import { AuditCsvByteCounter } from "@/contexts/administration/interface/http/audit/audit-csv-byte-counter"
import { AUDIT_CSV_MAX_BYTES } from "@/contexts/administration/interface/http/audit/to-audit-csv-row"
...
function invalidQuery(cause: unknown): ValidationError {
  return new ValidationError("audit query is invalid", "audit_invalid_query", {
    cause,
  })
}
