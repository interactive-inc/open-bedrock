...
export class VerifyHealthCheckupRetirementPage {
  ...
  async execute(
    ...
    const authority = await new HealthCheckupRecordSystemAdapter(
      this.c,
    ...
    const plan = await new HealthCheckupRecordSystemAdapter(context)
      .retirementPlans()
      .find(command.planId)
    ...
    const repository = new HealthCheckupRecordSystemAdapter(context).retirementReceipts()
    ...
    const keys = await new HealthCheckupRecordSystemAdapter({
      env: this.c.env,
    ...
    const guarded = new HealthCheckupRecordSystemAdapter(guardedContext).retirementReceipts()
    ...
    const page = await new HealthCheckupRecordSystemAdapter(guardedContext)
      .coveragePages()
