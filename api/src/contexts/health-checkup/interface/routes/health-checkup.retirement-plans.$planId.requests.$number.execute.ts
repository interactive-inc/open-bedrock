import { zAppHealthCheckupRetirementExecution } from "@/contexts/health-checkup/interface/http/response-schemas"
import { z } from "zod"
import { zValidator } from "@hono/zod-validator"
import { healthCheckupFactory } from "@/contexts/health-checkup/interface/request-environment/health-checkup-factory"
import { ExecuteHealthCheckupRetirementAdapter } from "@/contexts/health-checkup/infrastructure/adapters/execute-health-checkup-retirement.adapter"
import {
...
export const POST = healthCheckupFactory.createHandlers(
  ...
  async (c) => {
    ...
    const submitted = await new ExecuteHealthCheckupRetirementAdapter(c).execute(
      {
    ...
    return c.json(zAppHealthCheckupRetirementExecution.parse(submitted), 200)
  },
)
