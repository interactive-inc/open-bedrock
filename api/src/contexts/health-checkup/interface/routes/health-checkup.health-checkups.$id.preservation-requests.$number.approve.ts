import { createHealthCheckupPreservationDecisionHandlers } from "@/contexts/health-checkup/interface/operations/create-health-checkup-preservation-decision-handlers"
...
export const POST = healthCheckupFactory.createHandlers(
  ...
  ...createHealthCheckupPreservationDecisionHandlers("approve"),
)
