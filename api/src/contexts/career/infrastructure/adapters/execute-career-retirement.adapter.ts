...
export class ExecuteCareerRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new CareerRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new CareerRetirementConflictError("retirement verified scope differs")
    ...
    const replay = async () => {
      ...
      if (
        ...
        return new CareerRetirementConflictError("retirement was finalized under another proposal")
    ...
    if (proposal.status !== "approved")
      return new CareerRetirementConflictError("retirement is not approved")
    ...
    if (finalized instanceof Error) {
      ...
      return new CareerRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
