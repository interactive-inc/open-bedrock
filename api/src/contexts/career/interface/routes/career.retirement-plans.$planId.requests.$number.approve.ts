import { createCareerRetirementDecisionHandlers } from "@/contexts/career/interface/operations/create-career-retirement-decision-handlers"
...
export const POST = careerFactory.createHandlers(
  ...
  ...createCareerRetirementDecisionHandlers("approve"),
)
