...
import {
  isAllowedMcpRedirectUri as inspectMcpRedirectUri,
  type McpRedirectUriConfiguration,
} from "@/contexts/system/domain/identity/mcp-redirect-uri.policy"

const configuration: McpRedirectUriConfiguration = {
  productionRedirectUris: ["https://connector.example/callback"],
  localHostnames: ["localhost", "127.0.0.1"],
  callbackPath: "/callback",
}

const isAllowedMcpRedirectUri = (value: string) => inspectMcpRedirectUri(value, configuration)

describe("is-allowed-mcp-redirect-uri", () => {
