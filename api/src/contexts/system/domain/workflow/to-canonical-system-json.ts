...
import type { SystemJsonValue } from "@system/domain/workflow/system-json-value"
...
/** JSON valueをkey順が安定した変更不能なcanonical文字列へ変換する。 */
export function toCanonicalSystemJson(value: unknown): string | InvalidSystemProposalError {
  try {
