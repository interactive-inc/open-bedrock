...
export class DecisionTaskCandidate {
  ...
  static create(input: unknown): DecisionTaskCandidate | InvalidSystemWorkflowError {
    ...
    return new DecisionTaskCandidate(parsed.data)
  }
