...
import { GET } from "@system/interface/routes/system.oauth.userinfo"
...
describe("GET /oauth/userinfo", () => {
  test("canonical AccountとIdentity profileだけからclaimを返す", async () => {
    ...
    const response = await client.system.oauth.userinfo.$get({
