...
export class CreatePendingSystemPasswordIdentityAdapter {
  constructor(private readonly c: Context) {
    Object.freeze(this)
  }

  async createPendingSystemPasswordIdentity(
    input: Readonly<{
    ...
    try {
      ...
      const auditRepository = new SystemAuditEventRepository(this.c)
      const statements = [
        database
          .prepare(
