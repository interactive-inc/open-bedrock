...
const rateLimit = new LoginRateLimitService(rateLimitContext)

const loginRateLimitKey = LoginRateLimitService.loginKey
const internalVerifyRateLimitKey = LoginRateLimitService.internalVerifyKey
