...
async function createTestDb(): Promise<D1Database> {
  ...
  await seedD1(db, "work_accidents", [
    {
      id: "0190000c-0000-7000-8000-000000000001",
    ...
    {
      id: "0190000c-0000-7000-8000-000000000002",
...
describe("POST /work-accidents", () => {
  test("creates an accident for admin (work_accident:manage)", async () => {
    ...
    const parsed = z
      .object({ status: z.string(), employee_id: zEmployeeId.nullable() })
...
describe("POST /work-accidents/:id/close", () => {
  test("closes a reported accident for admin", async () => {
    const response = await request({
      path: "/work-accident/work-accidents/0190000c-0000-7000-8000-000000000001/close",
      token: await tokenFor(1),
      method: "POST",
    })
  ...
  test("returns 409 when already closed", async () => {
    const response = await request({
      path: "/work-accident/work-accidents/0190000c-0000-7000-8000-000000000002/close",
      token: await tokenFor(1),
      method: "POST",
    })
