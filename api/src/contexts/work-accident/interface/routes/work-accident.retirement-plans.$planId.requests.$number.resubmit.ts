import { zAppWorkAccidentRetirementRequest } from "@/contexts/work-accident/interface/http/response-schemas"
import { z } from "zod"
import { zValidator } from "@hono/zod-validator"
import { workAccidentFactory } from "@/contexts/work-accident/interface/request-environment/work-accident-factory"
import { SubmitWorkAccidentRetirementRequestAdapter } from "@/contexts/work-accident/infrastructure/adapters/submit-work-accident-retirement-request.adapter"
import {
...
export const POST = workAccidentFactory.createHandlers(
  ...
  async (c) => {
    ...
    const submitted = await new SubmitWorkAccidentRetirementRequestAdapter(c).execute(
      {
        revision: {
          mode: "resubmit",
    ...
    return c.json(
      zAppWorkAccidentRetirementRequest.parse(submitted.request),
