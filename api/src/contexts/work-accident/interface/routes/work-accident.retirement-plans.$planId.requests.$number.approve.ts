import { createWorkAccidentRetirementDecisionHandlers } from "@/contexts/work-accident/interface/operations/create-work-accident-retirement-decision-handlers"
...
export const POST = workAccidentFactory.createHandlers(
  ...
  ...createWorkAccidentRetirementDecisionHandlers("approve"),
)
