...
const secret = "governance-integration-test-secret"

/** 実System・Companyと規程・ガバナンス8台帳の原記録を接続する保全fixture。 */
export async function createGovernancePreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "governance-preservation",
    revision: 1,
    title: "Preserve governance records",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "governance-pagination-test-pepper",
