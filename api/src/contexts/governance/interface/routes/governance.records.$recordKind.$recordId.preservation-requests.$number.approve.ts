import { createGovernancePreservationDecisionHandlers } from "@/contexts/governance/interface/operations/create-governance-preservation-decision-handlers"
...
export const POST = governanceRecordFactory.createHandlers(
  ...
  ...createGovernancePreservationDecisionHandlers("approve"),
)
