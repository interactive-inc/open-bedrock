...
/** governance責務割当記録の停止と解除を、人の技術権限と再認証へ接続する。 */
export function createGovernanceSourceFreezeHandlers(mode: "create" | "release") {
  return governanceFactory.createHandlers(
    requireSystemStepUp,
