import { createSkillRetirementDecisionHandlers } from "@/contexts/skill/interface/operations/create-skill-retirement-decision-handlers"
...
export const POST = skillFactory.createHandlers(
  ...
  ...createSkillRetirementDecisionHandlers("approve"),
)
