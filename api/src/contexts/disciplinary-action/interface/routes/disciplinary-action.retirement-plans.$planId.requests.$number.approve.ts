import { createDisciplinaryActionRetirementDecisionHandlers } from "@/contexts/disciplinary-action/interface/operations/create-disciplinary-action-retirement-decision-handlers"
...
export const POST = disciplinaryActionFactory.createHandlers(
  ...
  ...createDisciplinaryActionRetirementDecisionHandlers("approve"),
)
