...
export class ExecuteRegulationRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new RegulationRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new RegulationRetirementConflictError("retirement verified scope differs")
    ...
    if (proposal.status !== "approved")
      return new RegulationRetirementConflictError("retirement is not approved")
    ...
    if (finalized instanceof Error) {
      ...
      return new RegulationRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
