import { zAppRegulationRetirementExecution } from "@/contexts/regulation/interface/http/response-schemas"
import { z } from "zod"
import { zValidator } from "@hono/zod-validator"
import { regulationFactory } from "@/contexts/regulation/interface/request-environment/regulation-factory"
import { ExecuteRegulationRetirementAdapter } from "@/contexts/regulation/infrastructure/adapters/execute-regulation-retirement.adapter"
import {
...
export const POST = regulationFactory.createHandlers(
  ...
  async (c) => {
    ...
    const submitted = await new ExecuteRegulationRetirementAdapter(c).execute(
      {
    ...
    return c.json(zAppRegulationRetirementExecution.parse(submitted), 200)
  },
)
