import { COMPANY_PERMISSION_KEYS } from "@/contexts/company-compatibility/domain/iam/company-permission-key.catalog"
import { SYSTEM_PERMISSION_KEYS } from "@/contexts/system/domain/iam/system-permission-key.catalog"
import { LEGACY_BUSINESS_PERMISSION_KEYS } from "@/contexts/company-compatibility/domain/iam/legacy-business-permission-key.catalog"
import { SYSTEM_CAPABILITY_PERMISSION_KEYS } from "@/contexts/company-compatibility/domain/iam/system-capability-permission-key.catalog"
import { z } from "zod"
