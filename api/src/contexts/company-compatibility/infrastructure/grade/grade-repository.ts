import { Grade } from "@/contexts/company-compatibility/domain/grade/grade.entity"
import type { Context } from "@/env"
import { grades } from "@/contexts/company-compatibility/infrastructure/schema/grade"
  ...
  async create(grade: Grade): Promise<Grade | Error> {
    try {
      ...
      if (isUniqueConstraintError(error)) {
        return new UniqueConstraintError("grade code already exists", { cause: error })
      }
