import { createThanksPreservationDecisionHandlers } from "@/contexts/thanks/interface/operations/create-thanks-preservation-decision-handlers"
...
export const POST = thanksFactory.createHandlers(
  ...
  ...createThanksPreservationDecisionHandlers("approve"),
)
