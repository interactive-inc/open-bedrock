import { createLifeEventPreservationDecisionHandlers } from "@/contexts/life-event/interface/operations/create-life-event-preservation-decision-handlers"
...
export const POST = lifeEventFactory.createHandlers(
  ...
  ...createLifeEventPreservationDecisionHandlers("approve"),
)
