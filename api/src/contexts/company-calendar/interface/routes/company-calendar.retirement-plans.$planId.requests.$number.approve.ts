import { createCompanyCalendarDayRetirementDecisionHandlers } from "@/contexts/company-calendar/interface/operations/create-company-calendar-retirement-decision-handlers"
...
export const POST = companyCalendarDayFactory.createHandlers(
  ...
  ...createCompanyCalendarDayRetirementDecisionHandlers("approve"),
)
