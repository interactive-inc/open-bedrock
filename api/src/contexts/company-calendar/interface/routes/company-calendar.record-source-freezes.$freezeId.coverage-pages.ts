...
import { VerifyCompanyCalendarDayCoveragePage } from "@/contexts/company-calendar/application/verify-company-calendar-day-coverage-page"
import {
...
import { zAppCompanyCalendarDayCoveragePageReceipt } from "@/contexts/company-calendar/interface/http/response-schemas"
...
export const POST = companyCalendarDayFactory.createHandlers(
  ...
  async (c) => {
    ...
    const command = companyCalendarDayCoveragePageCommandSchema.safeParse({
      ...c.req.valid("json"),
    ...
    return c.json(
      zAppCompanyCalendarDayCoveragePageReceipt.parse({
