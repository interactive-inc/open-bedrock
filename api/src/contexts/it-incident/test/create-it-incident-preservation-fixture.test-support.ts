...
const secret = "it-incident-integration-test-secret"

/** 実System・CompanyとITインシデント原記録を接続する保全fixture。 */
export async function createItIncidentPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "it-incident-preservation",
    revision: 1,
    title: "Preserve it-incidents",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "it-incident-pagination-test-pepper",
