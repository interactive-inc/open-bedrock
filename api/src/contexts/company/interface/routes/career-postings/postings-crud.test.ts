...
import { seedCareerApplications } from "@/contexts/company/infrastructure/seed/seed-career-applications"
...
describe("GET /career-postings/:posting_id", () => {
...
describe("PUT /career-postings/:posting_id", () => {
...
describe("DELETE /career-postings/:posting_id", () => {
