import { readOrganizationSnapshot } from "@/contexts/company/application/organization/read-organization-snapshot"
...
export const GET = factory.createHandlers(
  ...
  async (context) => {
    ...
    const result = await readOrganizationSnapshot(runtime.actor, query, (resourceQuery) =>
