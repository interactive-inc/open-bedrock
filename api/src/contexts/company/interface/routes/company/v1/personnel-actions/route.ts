import { readPersonnelActions } from "@/contexts/company/application/personnel-actions/read-personnel-actions"
...
export const GET = factory.createHandlers(
  ...
  async (context) => {
    ...
    const result = await readPersonnelActions(runtime.actor, query, (resourceQuery) =>
