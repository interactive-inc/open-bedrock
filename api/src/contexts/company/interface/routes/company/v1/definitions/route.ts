import { readCompanyDefinitions } from "@/contexts/company/application/definitions/read-company-definitions"
...
export const GET = factory.createHandlers(
  ...
  async (context) => {
    ...
    const result = await readCompanyDefinitions(runtime.actor, query, (resourceQuery) =>
