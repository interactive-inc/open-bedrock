import { readAccountEmployeeLinks } from "@/contexts/company/application/account-employee-links/read-account-employee-links"
...
export const GET = factory.createHandlers(
  ...
  async (context) => {
    ...
    const result = await readAccountEmployeeLinks(runtime.actor, query, (resourceQuery) =>
