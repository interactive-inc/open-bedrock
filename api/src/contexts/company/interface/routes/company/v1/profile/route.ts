import { readCompanyProfile } from "@/contexts/company/application/profile/read-company-profile"
...
export const GET = factory.createHandlers(
  ...
  async (context) => {
    ...
    const result = await readCompanyProfile(runtime.actor, query, (resourceQuery) =>
