import { OrganizationChangeService } from "@/contexts/company/application/workforce/organization-change-service"
...
function service(
  ...
  return {
    writes,
    value: new OrganizationChangeService({
      organization: {
        readSnapshot: async () => ({
          ok: true,
...
describe("OrganizationChangeService", () => {
