...
import { PrepareSystemAccountProvisioning } from "@system/infrastructure/identity/prepare-system-account-provisioning"
import type { Context } from "@/env"
import { abortWhenPreviousStatementChangedNoRows } from "@/lib/database/abort-when-previous-statement-changed-no-rows"

/** 既存のCompany Employee作成batchへSystem Account一式を接続する。 */
export class PrepareEmployeeAccountProvisioning {
