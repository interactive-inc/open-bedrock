...
import * as createRoute from "@/contexts/family-care-leave/interface/routes/family-care-leaves"
import * as detailRoute from "@/contexts/family-care-leave/interface/routes/family-care-leaves.$id"
import * as meRoute from "@/contexts/family-care-leave/interface/routes/family-care-leaves.me"
import { z } from "zod"
...
beforeAll(async () => {
  pool = await startLocalD1Pool(17)
})
...
const ownFamilyCareLeaveId = "20000000-0000-4000-8000-000000000002"

const othersFamilyCareLeaveId = "20000000-0000-4000-8000-000000000001"
