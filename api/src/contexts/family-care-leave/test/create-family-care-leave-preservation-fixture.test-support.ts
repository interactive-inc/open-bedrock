...
const secret = "family-care-leave-integration-test-secret"

/** 実System・Companyとfamily care leave原記録を接続する保全fixture。 */
export async function createFamilyCareLeavePreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "family-care-leave-preservation",
    revision: 1,
    title: "Preserve family-care-leaves",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "family-care-leave-pagination-test-pepper",
