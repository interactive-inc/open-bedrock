import { createFamilyCareLeaveRetirementDecisionHandlers } from "@/contexts/family-care-leave/interface/operations/create-family-care-leave-retirement-decision-handlers"
...
export const POST = familyCareLeaveFactory.createHandlers(
  ...
  ...createFamilyCareLeaveRetirementDecisionHandlers("approve"),
)
