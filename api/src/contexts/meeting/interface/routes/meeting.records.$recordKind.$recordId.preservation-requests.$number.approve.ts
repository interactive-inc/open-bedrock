import { createMeetingPreservationDecisionHandlers } from "@/contexts/meeting/interface/operations/create-meeting-preservation-decision-handlers"
...
export const POST = meetingFactory.createHandlers(
  ...
  ...createMeetingPreservationDecisionHandlers("approve"),
)
