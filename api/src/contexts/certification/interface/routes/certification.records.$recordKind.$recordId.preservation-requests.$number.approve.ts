import { createCertificationPreservationDecisionHandlers } from "@/contexts/certification/interface/operations/create-certification-preservation-decision-handlers"
...
export const POST = certificationFactory.createHandlers(
  ...
  ...createCertificationPreservationDecisionHandlers("approve"),
)
