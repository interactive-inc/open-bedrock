import { zAppCertificationRetirementExecution } from "@/contexts/certification/interface/http/response-schemas"
import { z } from "zod"
import { zValidator } from "@hono/zod-validator"
import { certificationFactory } from "@/contexts/certification/interface/request-environment/certification-factory"
import { ExecuteCertificationRetirementAdapter } from "@/contexts/certification/infrastructure/adapters/execute-certification-retirement.adapter"
import {
...
export const POST = certificationFactory.createHandlers(
  ...
  async (c) => {
    ...
    const submitted = await new ExecuteCertificationRetirementAdapter(c).execute(
      {
    ...
    return c.json(zAppCertificationRetirementExecution.parse(submitted), 200)
  },
)
