...
export class ExecuteCertificationRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new CertificationRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new CertificationRetirementConflictError("retirement verified scope differs")
    ...
    if (proposal.status !== "approved")
      return new CertificationRetirementConflictError("retirement is not approved")
    ...
    if (finalized instanceof Error) {
      ...
      return new CertificationRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
