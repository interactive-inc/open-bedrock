...
/** 実System・Companyと資格2台帳の原記録を接続する保全fixture。 */
export async function createCertificationPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "certification-preservation",
    revision: 1,
    title: "Preserve certification_definitions",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
