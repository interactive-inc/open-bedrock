...
import { VerifySoftwareLicenseCoveragePage } from "@/contexts/software-license/application/verify-software-license-coverage-page"
import {
...
import { zAppSoftwareLicenseCoveragePageReceipt } from "@/contexts/software-license/interface/http/response-schemas"
...
export const POST = softwareLicenseFactory.createHandlers(
  ...
  async (c) => {
    ...
    const command = softwareLicenseCoveragePageCommandSchema.safeParse({
      ...c.req.valid("json"),
    ...
    return c.json(
      zAppSoftwareLicenseCoveragePageReceipt.parse({
