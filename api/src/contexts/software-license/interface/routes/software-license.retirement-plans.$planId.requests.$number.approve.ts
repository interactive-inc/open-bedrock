import { createSoftwareLicenseRetirementDecisionHandlers } from "@/contexts/software-license/interface/operations/create-software-license-retirement-decision-handlers"
...
export const POST = softwareLicenseFactory.createHandlers(
  ...
  ...createSoftwareLicenseRetirementDecisionHandlers("approve"),
)
