...
export class ExecuteSoftwareLicenseRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new SoftwareLicenseRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new SoftwareLicenseRetirementConflictError("retirement verified scope differs")
    ...
    if (proposal.status !== "approved")
      return new SoftwareLicenseRetirementConflictError("retirement is not approved")
    ...
    if (finalized instanceof Error) {
      ...
      return new SoftwareLicenseRetirementConflictError("retirement changed before finalization", {
        cause: finalized,
      })
    }
