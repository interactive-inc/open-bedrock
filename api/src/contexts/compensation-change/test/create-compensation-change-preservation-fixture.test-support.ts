...
const secret = "compensation-change-integration-test-secret"

/** 実System・Companyと給与改定履歴の原記録を接続する保全fixture。 */
export async function createCompensationChangePreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "compensation-change-preservation",
    revision: 1,
    title: "Preserve compensation-change records",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "compensation-change-pagination-test-pepper",
