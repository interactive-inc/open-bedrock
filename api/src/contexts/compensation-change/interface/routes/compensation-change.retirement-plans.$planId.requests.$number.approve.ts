import { createCompensationChangeRetirementDecisionHandlers } from "@/contexts/compensation-change/interface/operations/create-compensation-change-retirement-decision-handlers"
...
export const POST = compensationChangeFactory.createHandlers(
  ...
  ...createCompensationChangeRetirementDecisionHandlers("approve"),
)
