import { createKnowledgePreservationDecisionHandlers } from "@/contexts/knowledge/interface/operations/create-knowledge-preservation-decision-handlers"
...
export const POST = knowledgeFactory.createHandlers(
  ...
  ...createKnowledgePreservationDecisionHandlers("approve"),
)
