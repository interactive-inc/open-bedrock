...
export const leaveSourceFreezeResponseSchema = z.strictObject({
  freeze: recordSourceFreezeSnapshotSchema,
})

export const zAppLeaveCoveragePageReceipt = z.strictObject({
  id: z.uuid(),
  freezeId: z.uuid(),
...
export const zAppLeaveRetirementPlan = z.strictObject({
  id: z.uuid(),
  freezeId: z.uuid(),
  digest: z.string().regex(/^[0-9a-f]{64}$/),
  totalPages: z.number().int().positive().safe(),
  recordKinds: z.array(leaveRecordKindSchema).length(4),
  createdAt: z.iso.datetime(),
})
export const zAppLeaveRetirementVerificationReceipt = z.strictObject({
  id: z.uuid(),
  planId: z.uuid(),
...
export const zAppLeaveRetirementRequest = z.strictObject({
...
export const zAppLeaveRetirementExecution = z.strictObject({
