import { createLeaveRetirementDecisionHandlers } from "@/contexts/leave/interface/operations/create-leave-retirement-decision-handlers"
...
export const POST = leaveFactory.createHandlers(
  ...
  ...createLeaveRetirementDecisionHandlers("approve"),
)
