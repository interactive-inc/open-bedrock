...
import { VerifyCommendationRetirementPage } from "@/contexts/commendation/application/verify-commendation-retirement-page"
...
import { zAppCommendationRetirementVerificationReceipt } from "@/contexts/commendation/interface/http/response-schemas"
...
export const POST = commendationFactory.createHandlers(
  ...
  async (c) => {
    ...
    const command = commendationRetirementVerificationCommandSchema.safeParse({
      ...c.req.valid("json"),
    ...
    return c.json(
      zAppCommendationRetirementVerificationReceipt.parse({
