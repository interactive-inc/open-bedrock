import { createCommendationRetirementDecisionHandlers } from "@/contexts/commendation/interface/operations/create-commendation-retirement-decision-handlers"
...
export const POST = commendationFactory.createHandlers(
  ...
  ...createCommendationRetirementDecisionHandlers("approve"),
)
