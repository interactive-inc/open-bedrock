...
const secret = "commendation-integration-test-secret"

/** 実System・Companyと表彰原記録を接続する保全fixture。 */
export async function createCommendationPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "commendation-preservation",
    revision: 1,
    title: "Preserve commendations",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "commendation-pagination-test-pepper",
