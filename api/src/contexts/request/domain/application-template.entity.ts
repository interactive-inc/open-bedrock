...
type ApplicationTemplatePersistenceRow = {
  id: number
  code: string
  name: string
  category: string
  ...
  completionHandlerKey?: "personnel_action" | null
}
...
export class ApplicationTemplate implements Props {
  ...
  static fromRow(row: ApplicationTemplatePersistenceRow): ApplicationTemplate | Error {
