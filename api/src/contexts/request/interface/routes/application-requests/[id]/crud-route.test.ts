...
describe("PUT /application-requests/:id", () => {
  test("returns 200 and updates payload for the applicant on a pending application", async () => {
    const response = await request("/application-requests/1", await tokenFor(5, "member"), {
      method: "PUT",
  ...
  test("returns 403 when not the applicant", async () => {
    const response = await request("/application-requests/1", await tokenFor(9, "member"), {
      method: "PUT",
  ...
  test("returns 409 when the application is already decided", async () => {
    const response = await request("/application-requests/3", await tokenFor(10, "member"), {
      method: "PUT",
  ...
  test("returns 404 for an unknown id", async () => {
    const response = await request("/application-requests/9999", await tokenFor(5, "member"), {
      method: "PUT",
      body: { payload: {} },
    })
  ...
  test("returns 404 for a non numeric id", async () => {
    const response = await request("/application-requests/abc", await tokenFor(5, "member"), {
      method: "PUT",
      body: { payload: {} },
    })
  ...
  test("returns 401 without a bearer token", async () => {
    const response = await request("/application-requests/1", null, {
      method: "PUT",
      body: { payload: {} },
    })
...
describe("DELETE /application-requests/:id", () => {
  ...
  test("returns 401 without a bearer token", async () => {
    const response = await request("/application-requests/1", null, { method: "DELETE", body: {} })
