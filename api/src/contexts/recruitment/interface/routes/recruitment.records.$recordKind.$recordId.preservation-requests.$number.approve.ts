import { createRecruitmentPreservationDecisionHandlers } from "@/contexts/recruitment/interface/operations/create-recruitment-preservation-decision-handlers"
...
export const POST = recruitmentFactory.createHandlers(
  ...
  ...createRecruitmentPreservationDecisionHandlers("approve"),
)
