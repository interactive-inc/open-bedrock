...
const secret = "recruitment-integration-test-secret"

/** 実System・Companyと採用2台帳の原記録を接続する保全fixture。 */
export async function createRecruitmentPreservationFixture(database: D1Database) {
  ...
  const definition = ProcedureDefinitionEntity.create({
    key: "recruitment-preservation",
    revision: 1,
    title: "Preserve recruitment records",
    category: "system",
    description: null,
    inputSchema: { fields: [] },
  ...
  const bindings = {
    ...
    DB: database,
    JWT_SECRET: secret,
    PEPPER_SECRET: "recruitment-pagination-test-pepper",
