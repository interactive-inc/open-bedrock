import { createRingiPreservationDecisionHandlers } from "@/contexts/ringi/interface/operations/create-ringi-preservation-decision-handlers"
...
export const POST = ringiFactory.createHandlers(
  ...
  ...createRingiPreservationDecisionHandlers("approve"),
)
