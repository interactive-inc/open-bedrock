...
export class ExecuteCertificateRequestRetirementAdapter {
  ...
  async execute(input: unknown, stepUpToken: string) {
    ...
    if (
      ...
      return new CertificateRequestRetirementConflictError("retirement proposal version differs")
    ...
    if (
      ...
      return new CertificateRequestRetirementConflictError("retirement verified scope differs")
    ...
    if (proposal.status !== "approved")
      return new CertificateRequestRetirementConflictError("retirement is not approved")
