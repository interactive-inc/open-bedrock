...
beforeAll(async () => {
  pool = await startLocalD1Pool(18)
})
...
const ownCertificateRequestId = "20000000-0000-4000-8000-000000000002"

const othersCertificateRequestId = "20000000-0000-4000-8000-000000000001"
