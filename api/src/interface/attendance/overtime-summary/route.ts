import { countBusinessDays } from "@/interface/attendance/overtime-summary/count-business-days"
...
// GET /attendance/overtime-summary?month=&scope= — 時間外の参考集計。
// scope=reports は attendance:read:reports、scope=all は attendance:read:all を要求する（GET /attendance と同じ判定）。
