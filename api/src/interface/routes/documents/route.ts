import { RegisterDocument } from "@/application/document/register-document"
...
/** GET /documents — 文書台帳一覧（document:read:all）。期限の近い順（期限なしは末尾）。 */
...
/** POST /documents — 文書台帳へ新規登録（document:manage）。 */
