...
import { resolveTargetEmployeeId } from "@/interface/shared/resolve-target-employee-id"
...
// GET /grades/assignments?employee_id= — 従業員の等級割当履歴（self / grade:read:all / 配下かつ grade:read:reports）
...
// POST /grades/assignments — 等級の割当を記録（grade:manage）
