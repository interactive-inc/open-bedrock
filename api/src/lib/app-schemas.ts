...
/** 予算枠 1 件のレスポンス。consumed は消化合計、remaining は amount からの単純減算。 */
...
/** 予算枠の消化記録 1 件のレスポンス。 */
export const zAppBudgetConsumption = z.object({
  id: z.number(),
  budget_id: z.number(),
  amount: z.number(),
  note: z.string().nullable(),
...
export type AppBudgetConsumption = z.infer<typeof zAppBudgetConsumption>
