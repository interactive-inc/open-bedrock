...
INSERT INTO leave_requests (id, employee_id, leave_type, start_date, end_date, days, unit, hours, consumed_days, reason, status, approver_id, decided_comment, created_at) VALUES
  ('0190001e-0000-7000-8000-000000000001', 5, 'annual', '2026-06-01', '2026-06-03', 3, 'full_day', NULL, 3, '私用のため', 'pending', NULL, NULL, '2026-05-20T00:00:00Z'),
  ('0190001e-0000-7000-8000-000000000002', 10, 'special', '2026-07-10', '2026-07-10', 1, 'full_day', NULL, 1, NULL, 'approved', 4, '承認しました', '2026-05-21T00:00:00Z'),
  ('0190001e-0000-7000-8000-000000000003', 5, 'compensatory', '2026-06-15', '2026-06-15', 1, 'full_day', NULL, 1, '休日出勤の代休', 'pending', NULL, NULL, '2026-05-22T00:00:00Z'),
  ('0190001e-0000-7000-8000-000000000004', 5, 'annual', '2026-06-20', '2026-06-20', 1, 'hourly', 2, 0.25, '通院のため', 'pending', NULL, NULL, '2026-05-23T00:00:00Z');
