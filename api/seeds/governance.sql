...
INSERT INTO governance_org_role_assignments (id, org_role_code, employee_id, department_code, starts_on, ends_on, source_document_code, created_by_account_id, created_at, revoked_by_account_id, revoked_at) VALUES
  ('01900043-0000-7000-8000-000000000001', 'ciso', '01900062-0000-7000-8000-000000000004', NULL, '2026-01-05', NULL, NULL, '01900061-0000-7000-8000-000000000001', '2026-01-05T00:00:00Z', NULL, NULL),
  ('01900043-0000-7000-8000-000000000002', 'privacy-manager', '01900062-0000-7000-8000-000000000002', NULL, '2026-01-05', NULL, NULL, '01900061-0000-7000-8000-000000000001', '2026-01-05T00:00:00Z', NULL, NULL);
...
INSERT INTO governance_documents (id, code, title, kind, classification, owner_capability_code, steward_org_role_code, status, current_version_id, source_path, created_by_account_id, created_at, updated_at) VALUES
  ('00000000-0000-4000-8000-000000000001', 'remote-work-policy', '在宅勤務規程', 'policy', 'internal', 'policy-management', NULL, 'published', '00000000-0000-4000-8000-000000000101', 'docs/governance/remote-work-policy.md', '01900061-0000-7000-8000-000000000001', '2026-02-01T00:00:00Z', '2026-02-15T00:00:00Z'),
  ('00000000-0000-4000-8000-000000000002', 'information-security-policy', '情報セキュリティ基本規程', 'policy', 'internal', 'information-security', 'ciso', 'draft', '00000000-0000-4000-8000-000000000201', 'docs/governance/information-security-policy.md', '01900061-0000-7000-8000-000000000001', '2026-07-01T00:00:00Z', '2026-07-20T00:00:00Z');
...
- 在宅勤務は前日までに申請する
- 週 3 日を上限とする', '{"id":"remote-work-policy","title":"在宅勤務規程","kind":"policy","version":"1.0.0","classification":"internal","owner_capability":"policy-management","effective_from":"2026-03-01","review_due_on":"2027-03-01"}', NULL, 'seedhash-remote-work-100', '2026-03-01', NULL, '2027-03-01', 'published', '01900061-0000-7000-8000-000000000001', '2026-02-01T00:00:00Z', '01900061-0000-7000-8000-000000000001', '2026-02-15T00:00:00Z'),
...
INSERT INTO governance_acknowledgements (id, version_id, employee_id, content_hash, acknowledged_at) VALUES
  ('01900046-0000-7000-8000-000000000001', '00000000-0000-4000-8000-000000000101', '01900062-0000-7000-8000-000000000005', 'seedhash-remote-work-100', '2026-03-02T01:00:00Z'),
  ('01900046-0000-7000-8000-000000000002', '00000000-0000-4000-8000-000000000101', '01900062-0000-7000-8000-00000000000d', 'seedhash-remote-work-100', '2026-03-03T01:00:00Z');
