...
- 総務(general_affairs): 会議室・備品・通知・反社チェック。評価・勤怠などの人事データは見えない
...
- 労務系ドメイン(証明書発行・退職・産休育休介護・ライフイベント・出張・貸与品)に管理側 permission が無く、本人操作のみになっている。人事が代理処理・進捗管理するための permission が要る
- audit_logs を閲覧する API と permission が無く、監査ロールの実効性が限られる
