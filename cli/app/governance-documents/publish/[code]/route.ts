...
export const help = `bedrock governance-documents publish <code> --version <semver>`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    return c.json(
      await api(
        `/governance/documents/${encodeURIComponent(code)}/versions/${encodeURIComponent(input.version)}/publish`,
        { method: "POST" },
      ),
    )
  },
