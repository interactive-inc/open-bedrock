...
export const help = `bedrock governance-documents acknowledge <code>`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    if (!code) throw new UsageError("code が必要です")
    return c.json(
      await api(`/governance-documents/${encodeURIComponent(code)}/acknowledge`, {
        method: "POST",
      }),
    )
  },
