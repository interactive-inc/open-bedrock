...
export const help = `bedrock ringi-procedures [--definition '<workflow-json>' --expected-revision <n>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    if (query.definition === undefined)
      return c.text(JSON.stringify(await api("/ringi/ringi-procedures"), null, 2))
    ...
    const saved = await api("/ringi/ringi-procedures", {
      method: "PUT",
