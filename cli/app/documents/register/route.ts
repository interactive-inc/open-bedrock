...
export const help = `bedrock documents register --title <t> --location <l> [--category <c>] [--partner-code <p>] [--expires-on <d>] [--note <n>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    const response = await client.documents.$post({
      json: {
        title: query.title,
