...
export const help = `bedrock certificate-requests show --id <certificate-request-id>`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    const response = await client["certificate-request"]["certificate-requests"][":id"].$get({
      param: { id: query.id },
    })
