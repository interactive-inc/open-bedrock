...
export const help = `bedrock business-trips request --destination <s> --start <date> --end <date> --purpose <s> [--cost <n>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    const response = await client["business-trip"]["business-trips"].$post({
      json: {
