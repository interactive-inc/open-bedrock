...
export const help = `bedrock expense-procedures [--definition '<workflow-json>' --expected-revision <n>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    if (query.definition === undefined)
      return c.text(JSON.stringify(await api("/expense/expense-procedures"), null, 2))
    ...
    const saved = await api("/expense/expense-procedures", {
      method: "PUT",
