...
export const help = `bedrock software-licenses create --name <n> [--vendor <v>] [--category saas|software|other] [--seats <n>] [--renewal-deadline <d>] [--owner-employee-id <id>] [--note <t>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    const response = await client["software-licenses"].$post({
      json: {
        name: query.name,
        vendor: query.vendor,
