...
export const help = `bedrock position-definitions create --data <confirmed-definition.json> --idempotency-key <key>
...
export default createCompanyDefinitionCommandHandlers({ type: "position", action: "create", help })
