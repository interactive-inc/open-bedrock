...
export const help = `bedrock position-definitions delete --data <confirmed-definition.json> --idempotency-key <key>
...
export default createCompanyDefinitionCommandHandlers({ type: "position", action: "delete", help })
