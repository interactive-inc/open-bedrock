...
export const help = `bedrock licenses update <id> --name <n> [--vendor <v>] [--category saas|software|other] [--seats <n>] [--renewal-deadline <d>] [--owner-employee-id <id>] [--note <t>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    const response = await client.licenses[":id"].$put({
      param: { id: licenseId },
      json: {
        name: query.name,
        vendor: query.vendor,
