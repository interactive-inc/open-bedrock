...
export const help = `karte partners update <id> --name <n> [--category customer|supplier|other] [--corporate-number <cn>] [--note <t>]`
...
export default factory.createHandlers(
  ...
  async (c) => {
    ...
    const response = await client.partners[":id"].$put({
      param: { id: partnerId },
      json: {
        name: query.name,
