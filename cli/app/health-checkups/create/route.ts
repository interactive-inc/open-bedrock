...
export const help = `karte health-checkups create --employee-id <id> --fiscal-year <y> --kind <regular|stress_check> [--status <scheduled|completed|declined>] [--conducted <date>] [--note <n>]`
