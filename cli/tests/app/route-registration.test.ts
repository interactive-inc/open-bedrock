...
const previouslyUnregistered: ReadonlyArray<{ path: string; help: string }> = [
  ...
  { path: "/expenses/cancel", help: "expenses cancel" },
  { path: "/expenses/execute", help: "expenses execute" },
  ...
  { path: "/knowledge-articles/history", help: "knowledge-articles history" },
  { path: "/knowledge-articles/add", help: "knowledge-articles add" },
  { path: "/knowledge-articles/withdraw", help: "knowledge-articles withdraw" },
